...
<div class="wrapper bg-light">
    <div class="sidebar bg-light" data-color="dark" data-active-color="danger" style="background-color: #1b1e21!important;width:18vw!important;" >
        ...
        <div class="sidebar-wrapper">
            <ul class="nav">
                ...
                <hr>
                <li>
                    <a href="/today-lab-request">
                        <img src="{{asset('icons/lab_request.svg')}}" alt="icon" class="icon"> <span
                            class="mx-2"></span>
                        Lab Request <span class="text-danger">(Today)</span>
                    </a>
                </li>
                <hr>
                <li>
                    <a href="">
                        <img src="{{asset('icons/lab_request.svg')}}" alt="icon" class="icon"> <span
                            class="mx-2"></span>
                        Lab Request <span class="text-danger">(Pending)</span>
                    </a>
                </li>
                <hr>
                <li>
                    <a href="/completed">
                        <img src="{{asset('icons/lab_request.svg')}}" alt="icon" class="icon"> <span
                            class="mx-2"></span>
                       Lab Request <span class="text-danger">(Completed)</span>
                    </a>
                </li>
                <hr>
