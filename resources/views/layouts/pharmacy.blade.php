    ...
    <div class="sidebar s" data-color="dark" data-active-color="danger">
        ...
        <div class="sidebar-wrapper s">
            <ul class="nav">
                ...
                <li class="active">
                    <a href="/sales-form">
                        <img src="{{asset('icons/sell_med.png')}}" alt="icon" class="icon"> <span
                            class="mx-2"></span>
                       Sell Medicine
                    </a>
                </li>
                ...
                <li>
                    <a href="/sales">
                        <img src="{{asset('icons/sell_details.png')}}" alt="icon" class="icon"> <span
                            class="mx-2"></span>
                       Sale Details
                    </a>
                </li>
                ...
                <li>
                    <a href="/returns">
                        <img src="{{asset('icons/returns.png')}}" alt="icon" class="icon"> <span
                            class="mx-2"></span>
                       Returns
                    </a>
                </li>
