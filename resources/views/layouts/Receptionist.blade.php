    ...
    <div class="sidebar" data-color="dark" data-active-color="danger">
        ...
        <div class="sidebar-wrapper s">
            <ul class="nav">
                <li>
                    <a href="/new-patient">
                        <img src="{{asset('icons/new_patient.png')}}" alt="icon" class="icon"> <span
                            class="mx-2"></span>
                       New Patient
                    </a>
                </li>
                ...
                <li>
                    <a href="/visit">
                        <img src="{{asset('icons/visits.png')}}" alt="icon" class="icon"> <span
                            class="mx-2"></span>
                        Visit
                    </a>
                </li>
                ...
                <li class="nav-item dropdown">
                    <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                        <img src="{{asset('icons/ap.png')}}" alt="icon" class="icon"> <span
                            class="mx-2"></span>     Appointments
                    </a>

                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="/check-appointment-availability">
                            Confirm Appointment
                        </a>
                    </div>
                </li>
